...
class Actor(nn.Module):
    def __init__(self, input_num, hidden_num, num_output, layers=1):
...
class Critic(nn.Module):
    def __init__(self, input_num, hidden_num, num_output=1, layers=1):
...
class PPO:
    def __init__(self, j_env, unit_num=200, memory_size=5, batch_size=32, clip_ep=0.2):
    ...
    def update(self, bs, ba, br, bp):
        ...
        for i in range(self.UPDATE_STEPS):
            ...
            # priority replay
            for k in range(self.REPLAY_NUM):
