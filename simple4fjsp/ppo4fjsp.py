...
from simple4fjsp import JobEnv
...
if __name__ == '__main__':
    name = "6-idle-simple4-fjsp"
    param = [name, "converged_iterations", "total_time", 'min']
    path = "MK/"
    for i in range(1):
        name = name + str(i)
    ...
    # results.to_csv("MK-6PDR_result-large.csv")