...
if __name__ == "__main__":
    x_labels = ['la01', 'la02', 'la11', 'la16', 'la21', 'la22', 'la23', 'la24', 'la25', 'la26', 'la27', 'la28', 'la29', 'la30', 'la31', 'la32',
                'la33', 'la34', 'la35', 'la36', 'la37', 'la38', 'la39', 'la40', 'ta21', 'ta22', 'ta31', 'ta32',
                'ta41', 'ta42', 'ta51', 'ta52', 'ta61', 'ta62', 'ta71', 'ta72']
    trajectories = pd.read_excel("data/trajectories.xls")
    traj = trajectories.values[:, 1:6]
    time = pd.read_excel("data/time.xls")
    ...
    ax.set_ylabel('trajectories', fontdict=font1)
